export const UNI_LIST = 'https://ipfs.io/ipns/tokens.uniswap.org';
export const UNI_EXTENDED_LIST = 'https://ipfs.io/ipns/extendedtokens.uniswap.org';
...
export const UNISWAP_TOKENS_LIST_URL = 'https://ipfs.io/ipns/tokens.uniswap.org';
